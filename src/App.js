...
const blue_unpressed_fill = {
  fill: "#268bd1"
}

const blue_pressed_fill = {
  fill: "#00599f"
}

const red_unpressed_fill = {
  fill: "#c92700"
}

const red_pressed_fill = {
  fill: "#741a00"
}

const yellow_unpressed_fill = {
  fill: "#e9a400"
}

const yellow_pressed_fill = {
  fill: "#946000"
}

function App() {
  let [clicks, setClicks] = useState([0, 0, 0, 0]);
  let [isPressed, setIsPressed] = useState([false, false, false, false]);

  const incrementClicks = (index) => {
    clicks[index]++;
    setClicks(clicks);
  }
